...
<svg viewBox="0 0 800 220" xmlns="http://www.w3.org/2000/svg" style="width:100%;border-radius:10px;margin-bottom:1.5rem;">
  ...
  <!-- Arrow: farm to school -->
  <line x1="440" y1="135" x2="230" y2="135" stroke="#4CAF50" stroke-width="2.5" marker-end="url(#gr)"/>
  <text x="380" y="122" text-anchor="middle" fill="#2E7D32" font-size="10" font-family="Georgia,serif">local produce</text>
  <!-- Farm / field -->
  <g transform="translate(440, 100)">
    ...
    <text x="50" y="90" text-anchor="middle" fill="#2E7D32" font-size="9" font-family="Georgia,serif">local farms</text>
  </g>
  <!-- Bowl of food -->
  <g transform="translate(590, 85)">
    ...
    <text x="75" y="112" text-anchor="middle" fill="#8B4513" font-size="10" font-family="Georgia,serif">school meal</text>
  </g>
  <!-- ROI label -->
  <text x="400" y="208" text-anchor="middle" fill="#2E7D32" font-size="11" font-family="Georgia,serif" opacity="0.9">$1 invested in school feeding → $9 return in learning, health and local agriculture</text>
</svg>
...
Sudan has lost years — perhaps a generation — of education to conflict and dysfunction. A national school feeding programme, built for the long term, sourced from Sudan's own farms, protected by law, and run with genuine community ownership, is one of the highest-leverage investments a reconstructed Sudan could make. The evidence has been in for decades. The logistics are manageable. The financing is accessible. The only thing missing is the political will to treat children's education as the infrastructure it is.

---

## Further Reading — Kandaka Library

- [Food-Poverty-Vulnerability Index Analysis for the Nile Basin Region: Sudan](https://pub-0c3bb637d5f54b239fe4a4ef9b08bfe3.r2.dev/food-poverty-vulnerability-inde-unknown.pdf) — Quantitative mapping of food insecurity across Sudan's regions, essential for targeting a school feeding programme.
- [Sorghum Value Chain Analysis](https://pub-0c3bb637d5f54b239fe4a4ef9b08bfe3.r2.dev/sorghum-value-chain-analysis-food.pdf) — How local procurement of sorghum — Sudan's primary staple — could anchor a home-grown school feeding model.
- [The Gezira Scheme: Sudan's Struggle for Food Self-Sufficiency](https://pub-0c3bb637d5f54b239fe4a4ef9b08bfe3.r2.dev/the-gezira-scheme-sudan-s-stru-muriel-mirak-weissbach.pdf) — The history of Sudan's flagship agricultural project and its lessons for local food production at scale.
- [The Agricultural Potential of Sudan — Abdalla Ahmed Abdalla](https://pub-0c3bb637d5f54b239fe4a4ef9b08bfe3.r2.dev/the-agricultural-potential-of-s-abdalla-ahmed-abdalla-hassan-o.pdf) — Comprehensive case for Sudan's farming capacity as a foundation for food security programmes.
