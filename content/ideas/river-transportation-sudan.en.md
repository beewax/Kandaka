...
<svg viewBox="0 0 800 220" xmlns="http://www.w3.org/2000/svg" style="width:100%;border-radius:10px;margin-bottom:1.5rem;">
  ...
  <!-- Sky -->
  <rect width="800" height="220" fill="url(#sky2)"/>
  <!-- River banks -->
  <rect x="0" y="110" width="800" height="110" fill="url(#bank)"/>
  <rect x="0" y="125" width="800" height="80" fill="url(#nilewater)"/>
  <!-- River ripples -->
  ...
  <path d="M600,158 Q660,152 720,158 Q760,162 800,158" stroke="#5dade2" stroke-width="1" fill="none" opacity="0.4"/>
  <!-- Barge / river boat -->
  <g transform="translate(280, 128)">
    ...
    <!-- Wake -->
    <path d="M0,40 Q-20,48 -50,44" stroke="#a8d8f0" stroke-width="1.5" fill="none" opacity="0.6"/>
  </g>
  <!-- Palm trees on bank -->
  ...
  <!-- City labels -->
  <text x="100" y="82" text-anchor="middle" fill="#333" font-size="10" font-family="Georgia,serif" font-weight="bold">Khartoum</text>
  <text x="664" y="80" text-anchor="middle" fill="#333" font-size="10" font-family="Georgia,serif" font-weight="bold">Kosti</text>
  <!-- Distance arrow -->
  <line x1="130" y1="102" x2="630" y2="102" stroke="#333" stroke-width="1" marker-start="url(#arr)" marker-end="url(#arr2)" opacity="0.5"/>
  <!-- Caption -->
  <text x="400" y="210" text-anchor="middle" fill="#1a5276" font-size="11" font-family="Georgia,serif" opacity="0.9">Khartoum to Kosti: 320 km of navigable Nile — river freight costs 3× less than road haulage</text>
</svg>
...
- [Sudan's Infrastructure: A Continental Perspective](https://pub-0c3bb637d5f54b239fe4a4ef9b08bfe3.r2.dev/sudan-s-infrastructure-a-conti-unknown.pdf) — Cross-sector overview of Sudan's infrastructure deficits, including transport, energy, and logistics.
- [Urban Waterways in Global Cities](https://pub-0c3bb637d5f54b239fe4a4ef9b08bfe3.r2.dev/urban-waterways-in-global-citie-unknown.pdf) — Comparative study of how cities around the world have integrated river transport into urban and regional logistics networks.
- [Appraisal of the Development Program of the Sudan Railway — World Bank](https://pub-0c3bb637d5f54b239fe4a4ef9b08bfe3.r2.dev/appraisal-of-the-development-pr-world-bank.pdf) — Historical World Bank analysis of Sudan's transport infrastructure investment and institutional challenges.
- [Sudan Infrastructure Sector Overview — ICED](https://pub-0c3bb637d5f54b239fe4a4ef9b08bfe3.r2.dev/sudan-infrastructure-sector-ove-infrastructure.pdf) — Sector-by-sector assessment relevant for understanding transport gaps and investment priorities.
