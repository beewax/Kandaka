...
<svg viewBox="0 0 800 220" xmlns="http://www.w3.org/2000/svg" style="width:100%;border-radius:10px;margin-bottom:1.5rem;">
  ...
  <ellipse cx="330" cy="150" rx="230" ry="70" fill="url(#beam_cin_ar)"/>
  ...
  <text x="400" y="210" text-anchor="middle" fill="#FFE9A8" font-size="11" font-family="Georgia,serif" opacity="0.85">جهاز عرض ومولّد كهربائي وشاشة قماشية -- من دون حاجة إلى مبنى</text>
</svg>
