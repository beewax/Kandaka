...
**Status:** Bilingual article approved for publication by the user on 19 September 2026; production deployment pending verification.  
...
| I08 | `dongola-throne-hall-reconstruction-original.png` | Withheld from rendered drafts. Its central-hall apse and definite dome conflict with the corrected distinction between observed fabric and reconstructed features. File retained for reference. |
