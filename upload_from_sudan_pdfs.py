...
# (filename in Sudan PDFs folder, r2 key)
FILES = [
...
print("Uploading " + str(len(FILES)) + " files from Sudan PDFs folder...\n")
success = 0
for filename, key in FILES:
    local_path = os.path.join(SUDAN_PDF_FOLDER, filename)
...
print("\n" + str(success) + "/" + str(len(FILES)) + " uploaded successfully.")
